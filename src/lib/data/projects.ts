...
const items: Array<Project> = [
  {
    ...
    color: "#ff3e00",
    description:
      "This is an attempt to remake the legendary DxBall 2 as a part of our Level-1 Term-1 project using only C programming language. The game is made using the iGraphics library.",
    shortDescription: "DxBall 2 Remake using C",
    links: [
      {
